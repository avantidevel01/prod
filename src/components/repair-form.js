...
export default () => {
  ...
  const onSubmit = async data => {
    try {
      await fetch(`${process.env.GA_GATEWAY_URL}`, {
        method: "POST",
        mode: "cors",
        cache: "no-cache",
                  ...
                  <div className="mt-4 md:mr-4 md:w-1/2">
                    <label htmlFor="fname" className="text-gray-700">
                      ...
                      <input
                        ...
                        className="mt-1 p-2 block w-full border-gray-600 rounded border-2 placeholder-gray-500"
                      />
                      {errors.fname && (
                  ...
                  <div className="mt-4 md:mr-4 md:w-1/2">
                    <label htmlFor="email" className="text-gray-700">
                      ...
                      <input
                        ...
                        className="mt-1 p-2 block w-full border-gray-500 rounded border-2 placeholder-gray-500"
                      />
                      {errors.email && (
                        <p className="text-red-600 font-medium italic ml-2">
