  ...
  return (
    <div>
      <Layout>
        ...
        <main>
          <div className="px-6">
            <h1 className="text-3xl font-bold pt-4 pb-2 text-blue-800 leading-tight">
            ...
            <p className="text-gray-800 leading-normal text-lg my-2 py-2">
              ...
              someone you want to know. As a growing and expanding company,
              we’re always looking and working with partners who are on the
              cutting edge of new Medical Technologies.
            </p>
            ...
            <p className="text-gray-800 leading-normal text-lg my-2 py-2">
              ...
              best products and services, a personalized customer experience,
              and unparalleled industry support.
            </p>

            <p className="text-gray-800 leading-normal text-lg my-2 py-2">
              Whether your department is in Gastroenterology, Pulmonology,
              Surgery, SPD or another Specialized Department involving
              Endoscopy, we’re here for you to help solve any problem or
              situation you may encounter. We will help you figure out how to
              attain more effective and verifiable results with a focus on
              helping you provide "best practice" in patient care available
              today.
            </p>
